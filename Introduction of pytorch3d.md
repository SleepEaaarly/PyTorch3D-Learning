...
![2dexample](https://github.com/SleepEaaarly/PyTorch3D-Learning/tree/main/pictures2dexample.png)

* 3D dl遇到的问题：
  * Batch分组tensor维度不固定
  * 图形学操作(如渲染)不支持梯度

![2dvs3d](https://github.com/SleepEaaarly/PyTorch3D-Learning/tree/main/pictures2dvs3d.png)

## Goals

深度学习库特性(快速、模块化、可微) + 3D库特性(3D、不统一batching、结合3D操作)

![goals](https://github.com/SleepEaaarly/PyTorch3D-Learning/tree/main/picturesgoals.png)

## Components

![image-20230620111822144](https://github.com/SleepEaaarly/PyTorch3D-Learning/tree/main/picturesComponents.png)
...
![meshes](https://github.com/SleepEaaarly/PyTorch3D-Learning/tree/main/picturesmeshes.png)
...
![K Nearest Neighbor](https://github.com/SleepEaaarly/PyTorch3D-Learning/tree/main/picturesK_Nearest_Neighbor.png)
...
![Graph Conv](https://github.com/SleepEaaarly/PyTorch3D-Learning/tree/main/picturesGraph_Conv.png)
...
![Chamfer Loss](https://github.com/SleepEaaarly/PyTorch3D-Learning/tree/main/picturesChamfer_Loss.png)
...
![rendering scene](https://github.com/SleepEaaarly/PyTorch3D-Learning/tree/main/picturesdifferentiable_rendering.png)
...
![rasterization process 1](https://github.com/SleepEaaarly/PyTorch3D-Learning/tree/main/picturesrasterization_process_1.png)
...
![rasterization process 2](https://github.com/SleepEaaarly/PyTorch3D-Learning/tree/main/picturesrasterization_process_2.png)
...
![Rendering engine](https://github.com/SleepEaaarly/PyTorch3D-Learning/tree/main/picturesRendering_engine.png)
...
![Mesh texturing options](https://github.com/SleepEaaarly/PyTorch3D-Learning/tree/main/picturesMesh_texturing_options.png)
